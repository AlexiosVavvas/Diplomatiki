...
class DynamicsBase(ABC):
    ...
    def __init__(self, dt=0.001, x0=None, num_of_states=None, num_of_inputs=None, state_names=None):
        ...
        self.reset(x0)
        self.pos_dim = None  # to be defined in subclasses if applicable
        self.coord_convention = 'ENU'  # default coordinate convention [East - North - Up]
    ...
    def position(self, x=None):
        if x is None:
            return self.state[:self.pos_dim].copy()
        else:
            return x[:self.pos_dim].copy()
...
class SingleIntegrator(DynamicsBase):
    ...
    def __init__(self, dt=0.001, x0=None):
        ...
        self.pos_dim = 2 # Dimensionality of the position space [x, y]
...
class Quadcopter(DynamicsBase):
    ...
    def __init__(self, dt=0.001, x0=None, mass=0.1, damping=0.0, Q=None, R=None, z_target=1.0, motor_limits=None, zero_out_states=None):
        ...
        self.pos_dim = 3 # Dimensionality of the position space [x, y, z]
...
class FixedWing12DOFTrainer(DynamicsBase):
    ...
    def __init__(self, dt=0.001, x0=None, params=None, v_trim=10, use_linear_f=False, use_linear_fx_fu=False):
        ...
        self.pos_dim = 3 # Dimensionality of the position space [x, y, z]
        self.coord_convention = 'NED'  # North-East-Down
    ...
    def f_x_analytical(self, x, u, params, first_three_rows_only=False):
        """
        ...
        Args:
            ...
            first_three_rows_only: If True, only compute the 1st 3 rows (position kinematics). 
                                   They are the only relevant for cbf calculations since the others zero out eventualy.
    ...
    def f_x(self, x, u, first_three_rows_only=False):
        return self.f_x_analytical(x, u, self.params, first_three_rows_only)
