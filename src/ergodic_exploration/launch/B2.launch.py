...
def generate_launch_description():
    ...
    agent_configs = [
        {'agent_id': '1', 'y_pos': '120',  'x_pos': '140', 'z_pos':'-400', 'init_psi_deg': '45', 'l_bounds' : ['-20.0', '180.0', '-20.0', '180.0'],  'antenna_rad': '0.1', 'antenna_range_flag': 'false', 'talk_alike_flag' : 'false', 'agent_config': 'src/ergodic_exploration/launch/B2_agent.yaml'},
    ]
    # Create nodes list
    nodes = []
    ...
    for i, config in enumerate(agent_configs):
        ...
        agent_node = Node(
            ...
            '--obstacles_yaml', 'src/ergodic_exploration/launch/B2_obs.yaml',
            # '--kmax', '2',
