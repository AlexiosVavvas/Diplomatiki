...
def generate_launch_description():
    ...
    agent_configs = [
        {'agent_id': '1', 'x_pos': '50',  'y_pos': '0', 'z_pos':'-400', 'init_psi_deg': '90', 'l_bounds' : ['-20.0', '180.0', '-20.0', '180.0'],  'antenna_rad': '0.1', 'antenna_range_flag': 'false', 'talk_alike_flag' : 'false', 'agent_config': 'src/ergodic_exploration/launch/fixed_wing_free_fly_agent.yaml'},
    ]
    # Create nodes list
    nodes = []
