...
def generate_launch_description():
    ...
    agent_configs = [
        {'agent_id': '1', 'x_pos': '130',  'y_pos': '80',    'z_pos':'-400', 'init_psi_deg': '180', 'l_bounds' : ['-20.0', '180.0', '-20.0', '180.0'],  'antenna_rad': '0.01', 'antenna_range_flag': 'true', 'talk_alike_flag' : 'false', 'agent_config': 'src/ergodic_exploration/launch/B6_agent.yaml'},
        {'agent_id': '2', 'x_pos': '55',   'y_pos': '123.3', 'z_pos':'-400', 'init_psi_deg': '-60', 'l_bounds' : ['-20.0', '180.0', '-20.0', '180.0'],  'antenna_rad': '0.01', 'antenna_range_flag': 'true', 'talk_alike_flag' : 'false', 'agent_config': 'src/ergodic_exploration/launch/B6_agent.yaml'},
