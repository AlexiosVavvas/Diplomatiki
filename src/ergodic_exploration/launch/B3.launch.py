...
def generate_launch_description():
    ...
    agent_configs = [
        {'agent_id': '1', 'north': '70',  'east': '50', 'down':'-400', 'init_psi_deg': '15', 'l_bounds' : ['-20.0', '280.0','-20.0', '280.0',],  'antenna_rad': '0.1', 'antenna_range_flag': 'false', 'talk_alike_flag' : 'false', 'agent_config': 'src/ergodic_exploration/launch/B3_agent.yaml'},
    ]
    # Create nodes list
    nodes = []
    ...
    for i, config in enumerate(agent_configs):
        ...
        agent_node = Node(
            ...
            '--obstacles_yaml', 'src/ergodic_exploration/launch/B3_obs.yaml',
            # '--kmax', '2',
