...
![Quadrotor Ergodic Exploration](results/diplomatiki/images/gifs/phi2_animation.gif)
...
![Quadrotor Ergodic Exploration w/ Obstacles](results/diplomatiki/images/gifs/phiQuadWithObs_animation.gif)
...
![Quadrotor Ergodic Exploration w/ Obstacles + EKF Target Localisation](results/diplomatiki/images/gifs/phi_single_target_tracking_w_obstacles.gif)
...
- `src/ergodic_exploration/`: ROS2 package for multi-agent coordination
  - `my_erg_lib/`: Custom implementation of the ergodic control library with models, controllers, and utilities
...
- `scripts/`: Operational and visualization tools
  - `dashboard_ros.py`: Real-time Python dashboard for multi-agent visualization
  - `vis_ck_erg.py`: Real-time Ck coefficient visualization
  - Launch scripts for RViz, FlightGear, and ROS bag playback
- `results/diplomatiki/`: Case study results and media
  - `images/`: Visualization outputs, animations, and screenshots
- `docs/`: Supplemental documentation on architecture, math, and configuration

## ROS2 Integration

<img src="results/diplomatiki/images/images/ros/ros2_humble_icon.png" width="100" alt="ROS2 Humble Logo">
...
<div align="center">
<img src="results/diplomatiki/images/images/ros/rqt_ros_topology.png" width="80%" alt="ROS2 Node Topology">
</div>
...
<div align="center">
<img src="results/diplomatiki/images/images/ros/dashboard_ros_agent_traj.png" width="80%" alt="Multi-Agent Dashboard">
</div>
...
<div align="center">
<img src="results/diplomatiki/images/images/ros/dashboard_ros_erg_cost_focused.png" width="80%" alt="Cooperative Ergodic Metric">
</div>
...
<div align="center">
<img src="results/diplomatiki/images/images/ros/rviz_screenshot_w_boat.png" width="80%" alt="RViz 3D Visualization">
</div>
<div align="center">
<img src="results/diplomatiki/images/images/ros/rviz_screenshot_w_boat_and_car.png" width="80%" alt="RViz 3D Visualization">
</div>
<div align="center">
<img src="results/diplomatiki/images/images/ros/rviz_screen_airplane.png" width="80%" alt="RViz 3D Visualization">
</div>
*Airplane control 12-DoF non linear model, with direct inputs (elevator, aileron, rudder angles + throttle command)*
<div align="center">
<img src="results/diplomatiki/images/images/ros/rviz_tight_space_drone_2_focused.png" width="80%" alt="RViz 3D Visualization">
</div>
<div align="center">
<img src="results/diplomatiki/images/images/ros/rviz_tight_space_drone.png" width="80%" alt="RViz 3D Visualization">
</div>
<br><br>
...
<div align="center">
<img src="results/diplomatiki/images/images/potential_field_4.png" width="90%" alt="Potential field visualization">
</div>
...
<div align="center">
<img src="results/diplomatiki/images/gifs/measurementsEKF_animation_spawnTargets_Merge.gif" width="70%" alt="Multi-Target Tracking">
</div>
...
python scripts/vis_ck_erg.py --mode realtime --plot-mode ros-only 1
```
