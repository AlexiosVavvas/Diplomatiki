...
#include "my_interfaces/msg/detail/agent_data__rosidl_typesupport_fastrtps_c.h"
...
using _AgentData__ros_msg_type = my_interfaces__msg__AgentData;
...
size_t get_serialized_size_my_interfaces__msg__AgentData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AgentData__ros_msg_type * ros_message = static_cast<const _AgentData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AgentData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__AgentData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__msg__AgentData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AgentData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__AgentData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, AgentData)() {
