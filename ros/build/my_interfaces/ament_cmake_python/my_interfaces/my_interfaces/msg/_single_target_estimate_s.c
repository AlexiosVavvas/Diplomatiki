...
bool my_interfaces__msg__single_target_estimate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._single_target_estimate.SingleTargetEstimate", full_classname_dest, 62) == 0);
  }
  my_interfaces__msg__SingleTargetEstimate * ros_message = _ros_message;
  {  // target_id
...
{
  /* NOTE(esteve): Call constructor of SingleTargetEstimate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._single_target_estimate");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SingleTargetEstimate");
