...
bool my_interfaces__msg__ck_table__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._ck_table.CkTable", full_classname_dest, 35) == 0);
  }
  my_interfaces__msg__CkTable * ros_message = _ros_message;
  {  // model_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "model_type");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->model_type, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // l_bounds
    PyObject * field = PyObject_GetAttrString(_pymsg, "l_bounds");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->l_bounds.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'l_bounds'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // table_size
    PyObject * field = PyObject_GetAttrString(_pymsg, "table_size");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->table_size = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // ck_values
    PyObject * field = PyObject_GetAttrString(_pymsg, "ck_values");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->ck_values.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'ck_values'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of CkTable */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._ck_table");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CkTable");
  ...
  {  // model_type
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->model_type.data,
      strlen(ros_message->model_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "model_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // l_bounds
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "l_bounds");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->l_bounds.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->l_bounds.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->l_bounds.size * sizeof(double));
      assert(data != NULL);
  ...
  {  // table_size
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->table_size);
    {
      int rc = PyObject_SetAttrString(_pymessage, "table_size", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ck_values
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "ck_values");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->ck_values.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->ck_values.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ck_values.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
